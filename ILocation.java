 ...
 * locations in the maze. Locations should be <strong>immutable</strong>.
 ...
 * <li>
 * <p>
 * A two-argument constructor that takes the integer x- and y-coordinates of the
 ...
 * passed in is also a {@code Location} and has the same x- and y-coordinates as
 * the receiver.
 * </p>
 * </li>
 * <li>
